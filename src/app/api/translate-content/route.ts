  ...
  try {
    ...
    const response = await openai.responses.create({
      ...
      instructions: [
        ...
        "Preserve URLs, email addresses, numbers and formatting.",
        "When translating a person's full name from English to Arabic, transliterate the name naturally into Arabic script. Do not translate its meaning.",
